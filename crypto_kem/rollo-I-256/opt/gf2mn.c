...
const u1 MODULO_GF2_N[4] = {0x00, 0x01, 0x02, 0x05};
...
u1 leading_coefficient_div(pu4 pu4R, pu4 pu4V, pu4 pu4U, u1 degree_v, u1 degree_u, pu4 workspace)
{
    ...
    Mupliply_GF2m_With_PreCompute(pu4U + PARAM_M_LEN_WORD*degree_u,
                                  ...
                                  PARAM_M_LEN_WORD,
                                  PARAM_M);
//    Mupliply_GF2m_With_PreCompute(pu4V + PARAM_M_LEN_WORD*degree_v,
//                                  base_mult,
//                                  pu4R,
//                                  PARAM_M_LEN_WORD,
//                                  PARAM_M);
...
u1 modular_inverse_GF2mn(pu4 pu4R, pu4 pu4X, pu4 pu4modulo)
{
  ...
  while(Is_Zero(u, u1NbCoeff_u*PARAM_M_LEN_WORD))
  {
...
u2 ModularReduction(pu4 pu4X, u1 u1NbCoeffX, u1 u1ModuloDegree, u1 u1CoeffLength)
{
    ...
    for( u1i = u1NbCoeffX-1 ; u1i >= u1ModuloDegree ; u1i--)
    {
       ...
       Add_GF2m(pu4X + (u1i + MODULO_GF2_N[2] -  u1ModuloDegree)*MODULO_GF2M_LEN,
                pu4X + u1i*MODULO_GF2M_LEN,
                pu4X + (u1i+ MODULO_GF2_N[2] - u1ModuloDegree)*MODULO_GF2M_LEN,
                MODULO_GF2M_LEN);

       Add_GF2m(pu4X + (u1i + MODULO_GF2_N[3] -  u1ModuloDegree)*MODULO_GF2M_LEN,
                pu4X + u1i*MODULO_GF2M_LEN,
                pu4X + (u1i+ MODULO_GF2_N[3] - u1ModuloDegree)*MODULO_GF2M_LEN,
                MODULO_GF2M_LEN);
...
u2 PreCalculusRSR(pu4 pu4F, pu4 pu4S, pu4 pu4Workspace, pu1 u1TabDimInterSi, u1 u1SDimMax)
{
  u1 u1i;
...
/**
 * \fn u2 Rank_Support_Recover(pu4 E, pu4 pu4F, pu4 pu4Syndrom, pu4 pu4Workspace)
...
u2 Rank_Support_Recover(pu4 pu4E, pu4 pu4F, pu4 pu4Syndrom, pu4 pu4Workspace)
{
  ...
  PreCalculusRSR(pu4F, pu4Syndrom, pu4Workspace, pu1TabDimIntersection,u1SDim);
  ...
  //Gaussian elimination applied to recover the support E
