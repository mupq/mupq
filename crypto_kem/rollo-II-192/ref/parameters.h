...
#define ROLLOII_PARAM_N 193 /**< Parameter n of the scheme (code length) */
...
#define ROLLOII_PARAM_SECURITY 192 /**< Expected security level */

#define ROLLOII_PUBLIC_KEY_BYTES 2341
#define ROLLOII_SECRET_KEY_BYTES 2381
#define ROLLOII_CIPHERTEXT_BYTES 2469
#define ROLLOII_SHARED_SECRET_BYTES 64

#define ROLLOII_RBC_VEC_R_BYTES 97 //Number of bytes to store R elements of GF2^m
#define ROLLOII_RBC_VEC_N_BYTES 2341 //Number of bytes to store N elements of GF2^m
