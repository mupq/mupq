 ...
 */
static void rbc_plain_mul(rbc_poly o, const rbc_poly a, const rbc_poly b) {
 ...
 * \param[in] b Polynomial
 */
static void rbc_kar_fold(rbc_vec res, rbc_vec src, int32_t max, int32_t half_size) {
...
static void rbc_kar_mul(rbc_vec o, rbc_vec a, rbc_vec b, int32_t a_size, int32_t b_size, rbc_vec stack) {
  int32_t ha_size;
  rbc_vec a2, b2;
