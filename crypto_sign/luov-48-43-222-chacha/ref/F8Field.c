...
f8FELT f8multiply(f8FELT a, f8FELT b) {
	if (a == 0 || b == 0)
		return 0;
	return f8antilog((f8log(a) + f8log(b)) % f8units);
}
...
f8FELT f8inverse(f8FELT a) {
	return f8antilog((f8units - f8log(a)) % f8units);
}
...
*/
uint8_t f8log(f8FELT a)
{
	static const uint8_t f8LogTable[65536] =
	{
...
*/
uint8_t f8antilog(uint8_t a)
{
	static const uint8_t f8AntiLogTable[65536] =
	{
