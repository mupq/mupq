...
// #else
extern const uint16_t sdith_gf2p16_logtable[];
extern const uint16_t sdith_gf2p16_exptable[];
extern const uint32_t sdith_gf2p32_log1table[];
extern const uint16_t sdith_gf2p32_exp1table[65537][2];
// #endif
